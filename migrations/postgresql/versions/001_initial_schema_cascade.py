...
def downgrade():
    op.execute("DROP TRIGGER IF EXISTS trg_feedbacks_updated_at ON feedbacks")
    op.execute("DROP FUNCTION IF EXISTS maintain_updated_at()")
    ...
    op.drop_constraint("fk_sc_feedback", "status_changes", type_="foreignkey")
    op.drop_table("status_changes")
    op.drop_index("idx_fc_customer", table_name="feedback_customer")
    op.drop_constraint("fk_fc_customer", "feedback_customer", type_="foreignkey")
    op.drop_constraint("fk_fc_feedback", "feedback_customer", type_="foreignkey")
    ...
    op.drop_constraint("fk_feedbacks_topic", "feedbacks", type_="foreignkey")
